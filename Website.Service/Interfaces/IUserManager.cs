...
namespace Website.Service.Interfaces
{
    ...
    /// </summary>
    public interface IUserManager : IUserManager<UserDTO>, ICustomUserManager
    {
    }
    ...
    public interface IUserManager<TUser> where TUser : class
    {
        ...
        /// </summary>
        /// <exception cref="NotSupportedException">Store does not implement IQueryableUserStore{TUser}</exception>  
        ...
        /// <returns>
        /// The <see cref="Task"/> that contains the result the asynchronous operation, the current failed access count for the user.
        /// </returns>
        ...
        /// <returns>
        /// The <see cref="Task"/> that represents the asynchronous operation, containing a list of role names.
        /// </returns>
        ...
        /// <returns>
        /// The <see cref="Task"/> that represents the asynchronous operation, containing the security stamp for the specified <paramref name="user"/>.
        /// </returns>
        ...
        /// <returns>T
        /// he User ID claim value, or null if the claim is not present.
        /// </returns>
        /// <remarks>
        /// The User ID claim is identified by <see cref="ClaimTypes.NameIdentifier"/>.
        /// </remarks>
        ...
        /// <returns>
        /// The <see cref="Task"/> that represents the asynchronous operation, containing the identifier for the specified <paramref name="user"/>.
        /// </returns>
        ...
        /// </returns>
        /// <remarks>
        /// The Name claim is identified by <see cref="ClaimsIdentity.DefaultNameClaimType"/>.
        /// </remarks>
        ...
        /// <returns>
        /// The <see cref="Task"/> that represents the asynchronous operation, containing the name for the specified <paramref name="user"/>.
        /// </returns>
